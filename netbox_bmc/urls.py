...
urlpatterns = [
    ...
    path("endpoints/<int:pk>/build-modules/", views.BuildModulesView.as_view(), name="bmcendpoint_build_modules"),
    path("endpoints/<int:pk>/build-modules/preview/", views.BuildModulesPreviewView.as_view(), name="bmcendpoint_build_modules_preview"),
    path("endpoints/<int:pk>/build-modules/apply/", views.BuildModulesApplyView.as_view(), name="bmcendpoint_build_modules_apply"),
